...
def launch_setup(context, *args, **kwargs):
    ...
    #     get_package_share_directory('fr3_teleop'),
    #     'rviz',
    #     'fr3_view.rviz'
    # )
    ...
    # Kinematic guides velocity controller.
    ...
    # --- Spawn the Kinematic Guides Velocity Teleop Controller via controller_manager ---
    nodes.append(Node(
        package='controller_manager',
        executable='spawner',
        arguments=[
    ...
    nodes.append(Node(
    package='fr3_teleop',  # or the marker publisher package
    executable='goal_marker_publisher',
    name='goal_marker_publisher',
    output='screen',
    parameters=[custom_controller_config],  # Path to param file with goal_positions
))
...
def generate_launch_description():
    declared_arguments = [
        ...
        #     'use_rviz',
        #     default_value='true',
        #     description='Visualize the robot and trajectories in RViz'
        # ),
        DeclareLaunchArgument(
            'use_fake_hardware',
            default_value='false',
